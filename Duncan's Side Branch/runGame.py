...
class RunGame():
    ...
    def display(self, function = None):
        ...
        finalLayout = runcommands.formatTerr(worldTerritories, territorySprites, highlightedTerritories, gui, self.colorTerritories, self.textList)
        ...
        while (not gameEnd):
            ...
            runcommands.sendSurface(finalLayout, self.surfaces, self.pygameWindow, self.textList, self.tempTerritoryList, self.topLevel, self.interfaceDice, self.functions)
