...
def updateVisualGetClick(self, temptroopValID, selectedTerritory, spriteLayer, pName):
    ...
    if temptroopValID != selectedTerritory: # Update selected territory visuals
...
def attacking(self, click, selectFlag, temptroopValID, spriteLayer, attackFlag, gui, territorySprites, finalLayout,
    ...
    if click[0] == 1 and not selectFlag:
        ...
        elif endTerritory.id_player != self.turn.turnCount and endTerritory.id in startTerritory.neighbors:  
